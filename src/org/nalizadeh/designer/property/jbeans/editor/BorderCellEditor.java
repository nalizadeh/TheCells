 ...
 * @version  1.0
 */
public class BorderCellEditor extends CustomCellEditor {

	private static final BorderCellRenderer renderer = new BorderCellRenderer();
	...
	protected Object startCustomEditor(Object value) {
		return CellsBorderChooser.showDialog(editor, (Border) value);
	}
}
