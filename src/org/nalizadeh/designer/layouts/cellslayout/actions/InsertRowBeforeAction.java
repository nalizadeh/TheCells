 ...
 * @version  1.0
 */
public class InsertRowBeforeAction extends CellsAction {

	private CellsDesigner designer;

	public InsertRowBeforeAction(CellsDesigner designer) {
		super("Insert new Row before");
...
class InsertRowBeforeUndoRedoAction extends AbstractUndoableEdit {
	private CellsDesigner designer;
	private int row;
	private double origHeight;

	public InsertRowBeforeUndoRedoAction(CellsDesigner designer, int row, double origHeight) {
		this.designer = designer;
		this.row = row;
