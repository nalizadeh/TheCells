...
/**
 * DataJarResources: DataJarResources maps all resources included in a
...
public final class JarResources {
   ...
   public byte[] getResource(String name) {
   	  if (!htJarContents.containsKey(name)) return null;
   ...
   private String dumpZipEntry(ZipEntry ze) {
    ...
    /**
    * Given a jar file and a resource name, it trys to extract the
    * resource and then makes an image from it.
    * @param
    */
	public ImageIcon getImage(String name) {
    	byte[] b = getResource(name);
