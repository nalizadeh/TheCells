 ...
 * @author Steve Wilson
 */
public class SoneInternalFrameTitlePane extends JComponent {
        ...
        private Icon iconifyRolloverIcon;
        private Icon closeRolloverIcon;
        ...
        public SoneInternalFrameTitlePane(JInternalFrame f) {
                frame = f;
                installTitlePane();
        }
        ...
        protected void installDefaults() {
                menuIcon = UIManager.getIcon("InternalFrame.menuIcon");
                maxIcon = UIManager.getIcon("RootPane.maximizeIcon");
                minIcon = UIManager.getIcon("RootPane.minimizeIcon");
                iconIcon = UIManager.getIcon("RootPane.iconifyIcon");
                closeIcon = UIManager.getIcon("RootPane.closeIcon");

                menuRolloverIcon = UIManager.getIcon("InternalFrame.menuRolloverIcon");
                maximizeRolloverIcon = UIManager.getIcon("InternalFrame.maximizeRolloverIcon");
                minimizeRolloverIcon = UIManager.getIcon("InternalFrame.minimizeRolloverIcon");
                iconifyRolloverIcon = UIManager.getIcon("InternalFrame.iconifyRolloverIcon");
                closeRolloverIcon = UIManager.getIcon("InternalFrame.closeRolloverIcon");
        ...
        protected void setButtonIcons() {
                if (frame.isIcon()) {
                        if (minIcon != null) {
                                ...
                                iconButton.setRolloverIcon(minimizeRolloverIcon);
                        }
                        if (maxIcon != null) {
                                maxButton.setIcon(maxIcon);
                                maxButton.setRolloverIcon(maximizeRolloverIcon);
                        }
                } else if (frame.isMaximum()) {
                        if (iconIcon != null) {
                                iconButton.setIcon(iconIcon);
                                iconButton.setRolloverIcon(iconifyRolloverIcon);
                        }
                        if (minIcon != null) {
                                maxButton.setIcon(minIcon);
                                maxButton.setRolloverIcon(minimizeRolloverIcon);
                        }
                } else {
                        if (iconIcon != null) {
                                iconButton.setIcon(iconIcon);
        ...
        private class Handler implements LayoutManager, PropertyChangeListener {
                ...
                public Dimension minimumLayoutSize(Container c) {
                        ...
                        Dimension dim = new Dimension(width, height + 4);
