...
class SoneSplitPaneDivider extends BasicSplitPaneDivider
{
    private SoneBumps bumps = new SoneBumps(10, 10,
                                MetalLookAndFeel.getControlHighlight(),
                                MetalLookAndFeel.getControlDarkShadow(),
                                MetalLookAndFeel.getControl() );

    private SoneBumps focusBumps = new SoneBumps(10, 10,
    ...
    public SoneSplitPaneDivider(BasicSplitPaneUI ui) {
        super(ui);
...
//        usedBumps.paintIcon(this, g, drawX, drawY);
    ...
    public class MetalDividerLayout implements LayoutManager {
	    ...
	    Insets      insets = getInsets();
            ...
            // splitpane divider.
            if (leftButton != null && rightButton != null && c == SoneSplitPaneDivider.this) {
