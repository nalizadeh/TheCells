...
public class SoneRootPaneUI extends BasicRootPaneUI
{
    /**
    ...
    private JComponent createTitlePane(JRootPane root) {
        return new SoneTitlePane(root, this);
    }
    ...
    /**
     * Invoked when a property changes. <code>SoneRootPaneUI</code> is
    ...
    private static class SoneRootLayout implements LayoutManager2 {
        /**
        ...
        public Dimension preferredLayoutSize(Container parent) {
            ...
            if (root.getWindowDecorationStyle() != JRootPane.NONE &&
                     (root.getUI() instanceof SoneRootPaneUI)) {
                JComponent titlePane = ((SoneRootPaneUI)root.getUI()).
                                       getTitlePane();
                if (titlePane != null) {
...
class FrameBorder extends AbstractBorder implements UIResource {
