...
class SoneBumps implements Icon {
    ...
    public SoneBumps( Dimension bumpArea ) {
        this( bumpArea.width, bumpArea.height );
    }

    public SoneBumps( int width, int height ) {
        this(width, height, MetalLookAndFeel.getPrimaryControlHighlight(),
             MetalLookAndFeel.getPrimaryControlDarkShadow(),
             MetalLookAndFeel.getPrimaryControlShadow());
    }

    public SoneBumps( int width, int height, Color newTopColor, Color newShadowColor, Color newBackColor ) {
